...
describe("summaryText", () => {
  it("renders a compact Thai summary", () => {
    ...
    expect(text).toBe([
      ...
      "รวมเบี้ยต่องวด (รายเดือน): 762 บาท",
      "รวมเบี้ยรายปี: 8,470 บาท",
  ...
  it("answers a bundle in full: no payment mode chosen, no price per line, all three totals", () => {
    ...
    expect(text).toBe([
      ...
      "Life Protect x 2 — ชำระเบี้ยครบอายุ 99 ปี",
      "เพศหญิง อายุ 40 ปี",
      "- Life Protect x 2 — ชำระเบี้ยครบอายุ 99 ปี ทุน 150,000 บาท",
      "- สัญญาเพิ่มเติมโรคร้ายแรง (DCI) ทุน 2,850,000 บาท",
      "ผลประโยชน์กรณีเสียชีวิต",
      "- เสียชีวิตก่อนอายุ 60 ปี: 3,150,000 บาท",
      "- อายุ 60–74 ปี: 3,000,000 บาท",
      "- อายุ 75 ปีขึ้นไป: 150,000 บาท",
      "เบี้ยประกันที่ต้องชำระ",
      "- รายปี: 15,112 บาท",
      "- ราย 6 เดือน: 7,858 บาท",
      "- รายเดือน: 1,360 บาท",
    ].join("\n"));
  });
