...
export function FaqSection({ facts }: { facts: LifeProtectCopyFacts }) {
  const faqs: { q: string; a: React.ReactNode }[] = [
    ...
    {
      q: "อยากได้เงินก้อนตอนป่วยหนักด้วย ทำยังไง",
      a: (
        <>
          แบบนี้คุ้มครองชีวิตอย่างเดียว ถ้าต้องการเงินก้อนตอนตรวจพบโรคร้ายแรงด้วย มีสองทาง —{" "}
          <Link href="/ishield" className="text-[var(--lg-gold)] underline underline-offset-4">iShield</Link>{" "}
          รวมโรคร้ายแรงไว้ในสัญญาหลัก เบี้ยไม่ขยับ คุ้มครองถึงอายุ 85 และคืนเต็มทุนถ้าอยู่ครบ ส่วน{" "}
          <Link href="/legacy" className="text-[var(--lg-gold)] underline underline-offset-4">ชุดมรดกเพื่อครอบครัว</Link>{" "}
          ใช้แบบเดียวกันนี้เป็นฐานแล้วพ่วงสัญญาโรคร้ายแรง ได้วงเงินสูงกว่าในเบี้ยเท่ากัน
          แต่เบี้ยส่วนนั้นขึ้นทุกปีและคุ้มครองถึงอายุ 75
        </>
      ),
    },
    {
