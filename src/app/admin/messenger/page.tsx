    ...
    <>
      ...
      <Card title="ใครคุยกับบอทได้บ้าง" hint="ตรวจกับคนนอกจริงแล้วเมื่อ 4 ก.ย. 2569">
        ...
        <p className="mt-2 text-sm text-slate-700">
          App Review จำเป็นก็ต่อเมื่อจะเอาบอทไปตอบเพจของธุรกิจอื่น ข้อความที่เตรียมไว้สำหรับยื่นอยู่ในไฟล์{" "}
          <code className="rounded bg-slate-100 px-1">docs/facebook-app-review.md</code> ในโปรเจกต์
        </p>
      </Card>
