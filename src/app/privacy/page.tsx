    ...
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <Section id="collect" title="ข้อมูลที่เก็บ">
        ...
        <p>
          ...
          ไว้ชั่วคราวในรูปแบบที่เข้ารหัสไว้ เพื่อส่งข้อความติดตามให้คุณ <strong>หนึ่งครั้ง</strong>{" "}
          หลังจากนั้นประมาณห้านาที รหัสนั้นจะถูกลบทิ้งทันทีที่ส่งข้อความแล้ว
          ลบทันทีถ้าคุณตอบกลับมาก่อน หรือถ้าตัวแทนเข้ามาตอบเอง และลบอัตโนมัติภายใน 24 ชั่วโมงไม่ว่ากรณีใด
          เราไม่ส่งข้อความติดตามซ้ำมากกว่าหนึ่งครั้ง และไม่ใช้รหัสนั้นเพื่อการอื่น
        </p>
        <p>
