...
/**
 * The sales page carries its own skin. Wrapping the route rather than the app leaves the
 * agent's calculator and the back office in the plain light theme they are worked in all day.
 */
