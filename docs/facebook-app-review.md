...
ระหว่างนี้บอทตอบได้เฉพาะคนที่มีบทบาทในแอป (แอดมิน ผู้พัฒนา ผู้ทดสอบ)
เพิ่มคนได้ที่ App Dashboard → บทบาทในแอพ → บทบาท

**LINE ไม่มีข้อจำกัดนี้** บัญชีทางการ LINE เปิดให้ทุกคนทักได้แล้วตั้งแต่วันแรก
